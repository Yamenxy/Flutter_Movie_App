...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/phone_icn.svg
  SvgGenImage get phoneIcn => const SvgGenImage('assets/icons/phone_icn.svg');

  /// List of all assets
  List<SvgGenImage> get values => [userIcn, phoneIcn];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/profile7.png
  AssetGenImage get profile7 =>
      const AssetGenImage('assets/images/profile7.png');

  /// File path: assets/images/profile8.png
  AssetGenImage get profile8 =>
      const AssetGenImage('assets/images/profile8.png');

  /// File path: assets/images/profile9.png
  AssetGenImage get profile9 =>
      const AssetGenImage('assets/images/profile9.png');
